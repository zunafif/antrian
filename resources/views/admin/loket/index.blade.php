  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header card-header-primary" style="background: linear-gradient(60deg, #00B59D, #00584D);">
        <h3 class="card-title">Master Loket</h3>
      </div>
      <div class="card-body">
        <div id="typography">
          <div class="card-title">
            <a href="{{route('counter_master.create')}}">
            ...
            <thead>
              ...
              @foreach($counter as $data)
                <tr>
                  ...
                  <td class="text-center">
                    @if($data->counter_type == 1)
                      <span class="btn btn-warning">Khusus</span>
                    @else
                      <span class="btn btn-info">Umum</span>
                    @endif
                  </td>
                  <td class="text-center">
                    <a href="{{route('counter_master.edit',['id' => $data->id])}}"><button class="btn btn-info"><i class="material-icons">edit</i> Edit</button></a>
                    <div class="btn btn-danger delete-button" data-id="{{$data->id}}"><i class="material-icons">delete</i> Delete</div> 
                  </td>
                </tr>
              @endforeach
            <tbody>
